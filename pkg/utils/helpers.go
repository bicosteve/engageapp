...
func (h *Helper) ReadJSON(w http.ResponseWriter, r *http.Request, data interface{}) error {
	maxBytes := 1048576
...
func (h *Helper) ErrorJSON(w http.ResponseWriter, err error, status ...int) error {
